...
def item_cf(user_id, item_id, similar_items, user_to_rating, topn=10):
    ...
    for similar_item, similarity in similar_items[item_id][:topn]:
        #用户对这相似电影的打分
        rating_by_similiar_item = user_to_rating[user_id][similar_item - 1]
        #分数*item_id的相似度，是一种对分数的加权，越相似的item越重要
...
if __name__ == "__main__":
    ...
    user_item_score_data_path = r"F:\motrix\新建文件夹\深度学习\第十七周推荐系统\week17 推荐系统\ml-100k\u.data"
    item_name_data_path = r"F:\motrix\新建文件夹\深度学习\第十七周推荐系统\week17 推荐系统\ml-100k\u.item"
